...
data class HomeUiState(
    ...
    val range: com.davidegea.spotifystats.domain.model.TimeRange? = null,
    val previousRange: com.davidegea.spotifystats.domain.model.TimeRange? = null,
    val previousDaily: List<com.davidegea.spotifystats.domain.model.DailyListening>? = null,
    val previousListeningMs: Long? = null,
